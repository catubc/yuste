...
#plot_contours(data_A, cn_filter, thr=0.9)
#check_contours(data_A, cn_filter, thr=0.95)


#**** PLOT RESULTS IN BOKEH FROM demo_OnACID_mesoscope output ********
data_in = '/home/cat/data/alejandro/G2M5/20170511/000/acid/processed_data.npz'
data_in = np.load(data_in)
Yr = data_in['Yr']
print Yr.shape
YrA = data_in['YrA']
print YrA.shape
...
nb_view_patches(Yr, A, C, b, f, 250, 250, YrA = YrA, thr = 0.8, image_neurons=Cn, denoised_color='red');
